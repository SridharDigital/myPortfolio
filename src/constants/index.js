...
const experiences = [
  {
    ...
    points: [
      "As the head of the frontend team, I upheld rigorous code quality standards, emphasizing design, readability, and performance, guiding the product from inception to its MVP launch.",
      "Set up secure user authentication and role-based access control via JWT and OAuth.",
      ...
      "Optimized performance to reduce the game load time from over 30 seconds to under 4 seconds.",
  ...
  },
  {
    ...
    points: [
      ...
      "Optimized site performance, cutting page load times by 15% and improving conversion rate of the funnel.",
  ...
  },
  {
    ...
    points: [
      "Built a dynamic image gallery with lazy loading functionality, improving page load times and user experience on image heavy pages.",
      "Developed an advanced filtering and sorting feature that allows users to sort products by price and utilize a search bar for easier navigation.",
      "Engaged in code reviews, enhancing coding skills and gaining insights from more experienced team members",
      "Built product catalog and shopping cart features in React, enabling seamless navigation and responsive design for an e-commerce platform.",
      ...
      "Tech Stack: HTML, CSS, JavaScript, React, Bootstrap, WordPress, SEO, Google Analytics.",
    ],
  },
  // {
